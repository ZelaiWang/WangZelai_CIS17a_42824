...
${OBJECTDIR}/grade.o: grade.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/grade.o grade.cpp
...
${OBJECTDIR}/reviewSchoolship.o: reviewSchoolship.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/reviewSchoolship.o reviewSchoolship.cpp

${OBJECTDIR}/selectCourse.o: selectCourse.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/selectCourse.o selectCourse.cpp
