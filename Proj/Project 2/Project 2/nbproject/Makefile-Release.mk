...
OBJECTFILES= \
	...
	${OBJECTDIR}/main.o \
	${OBJECTDIR}/pay.o \
	${OBJECTDIR}/reviewSchoolship.o \
	${OBJECTDIR}/selectCourse.o \
	${OBJECTDIR}/student.o
...
${OBJECTDIR}/reviewSchoolship.o: reviewSchoolship.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/reviewSchoolship.o reviewSchoolship.cpp

${OBJECTDIR}/selectCourse.o: selectCourse.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/selectCourse.o selectCourse.cpp
